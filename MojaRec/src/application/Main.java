...
public class Main extends Application
{
	...
	{		
		// Baza reci
		ArrayList<String> baza = new ArrayList<>(260000);
		try (BufferedReader reader = Files.newBufferedReader(Paths.get("src/sr.txt"), Charset.forName("UTF-8")))
		{
			String line = null;
		...
		// Dugmad
		Button btnRun = new Button("Реши");
		Button btnReset = new Button("Обриши");
